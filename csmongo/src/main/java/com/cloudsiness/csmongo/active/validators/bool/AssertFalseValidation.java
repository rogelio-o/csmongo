...
public class AssertFalseValidation implements CsConstraintValidator<AssertFalse> {
	...
	public void initialize(String message) {
		this.message = message == null || message.isEmpty() ? AssertFalse.MESSAGE : message;
	}
	...
	public void isValid(Object o, Function<String, CsValidationError> func, Handler<AsyncResult<CsValidationError>> handler) {
		if(o == null) {
			...
			handler.handle(Future.failedFuture(new CsValidatorNotValidForAttributeType("Only Boolean attributes are supported on AssertFalse validator.")));
			return;
		}
